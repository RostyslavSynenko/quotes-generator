...
class QuotesContsiner extends React.Component {
  ...
  handleClick = event => {
    const colorArray = [
      "#002962", "#007c86", "#9e324d", "#da1820", "#cccccc",
      ...
      "#bebebe", "#dddddd", "#cbbeb5", "#808080", "#c0d6e4",
      "#468499"
    ];
    ...
    const icons = document.querySelectorAll('.icons'); //for changing twitters & tumblrs buttons background
